...
/// <summary>
/// Internal registry for managing SceneState instances across plugins and framework states.
...
internal class SceneStateRegistry
{
    ...
    private readonly List<StateEntry> _frameworkStates = new();
    ...
    internal class StateEntry
    {
        ...
        public bool IsFrameworkState => Plugin == null;
    ...
    /// </summary>
    public void RegisterFramework(SceneState state)
    {
        var entry = new StateEntry(state, null);
        AddToSceneIndex(entry);
        _frameworkStates.Add(entry);
    }

    private void AddToSceneIndex(StateEntry entry)
    {
    ...
    /// <summary>
    /// Gets all framework states.
    /// </summary>
    public IEnumerable<StateEntry> GetFrameworkStates()
    {
        return _frameworkStates;
    }

    /// <summary>
    /// Gets the total number of registered states (including framework states).
    /// </summary>
    public int Count => _statesByPlugin.Values.Sum(list => list.Count) + _frameworkStates.Count;
}
